...
const faqItems: AccordionItemData[] = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p>
          Controlli automatici di qualita con <strong>Lighthouse CI</strong>:
        </p>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
            ...
            <p className="text-lg text-center text-[var(--color-neutral-600)] mb-12">
              Scopri tutte le funzionalita e tecnologie del progetto
            </p>
      ...
      {/* Footer */}
      <Footer
        description="Design System moderno costruito con AI-assisted development. Basato su UI Kit Italia per garantire accessibilita e coerenza visiva."
        columns={footerColumns}
        socialLinks={socialLinks}
        copyright="a9 2024 AI SDLC Design System e Built with Next.js, Tailwind CSS & Claude Code"
      />
    </div>
  );
}
